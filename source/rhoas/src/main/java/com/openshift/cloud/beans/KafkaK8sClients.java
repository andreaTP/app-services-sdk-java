...
public final class KafkaK8sClients {
  ...
  private CustomResourceDefinition initCloudServiceAccountRequestCRDAndClient(
    ...
    var akcCrdOptional = Optional.ofNullable(
            crds.customResourceDefinitions().withName("cloudserviceaccountrequests.rhoas.redhat.com").get());
  ...
  private CustomResourceDefinition initServiceRegistryConnectionCRDAndClient(
    ...
    var srcCrdOptional = Optional.ofNullable(
            crds.customResourceDefinitions().withName("serviceregistryconnections.rhoas.redhat.com").get());
